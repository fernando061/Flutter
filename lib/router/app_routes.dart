...
class AppRoutes{
  ...
  static final menuOptions = <MenuOption>[
    ...
    MenuOption(route: 'alert', name: 'Aler', screen: const AlertScreen(), icon: Icons.add_alert_outlined),
    ...
    MenuOption(route: 'slider', name: 'Slider Checjs', screen: const SliderScreen(), icon: Icons.slow_motion_video_rounded),
    MenuOption(route: 'listviewbuilder', name: 'InfiniteScrol & Pull to refresh', screen: const ListViewBuilderScreen(), icon: Icons.slow_motion_video_rounded),
